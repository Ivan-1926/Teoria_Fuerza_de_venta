...
4. **`supabase/04_auth_usuarios_demo.sql`** ← login Auth (contraseñas)
5. **`supabase/05_ruta_demo_asesor.sql`** ← visitas en pestaña Ruta ← roles docente (opcional si ya corriste 2)
