...
--
-- IMPORTANTE: la app cliente (banco_pichincha) tiene un trigger handle_new_user
-- que crea perfiles de CLIENTE al insertar en auth.users. Este script lo parchea
-- para NO crear perfil cliente cuando rol = asesor/supervisor/admin.
-- =============================================================================

create extension if not exists pgcrypto;

-- ─── Parche: no crear perfil bancario para staff FV ──────────────────────────
...
begin
  -- Asesor / supervisor / admin: solo Auth, sin tablas del banco cliente
...
-- Siguiente paso: ejecutar 05_ruta_demo_asesor.sql para ver visitas en la app
